---
title: "Roosevelt Island Tree Care Robot"
place: "Roosevelt Island Green Corridor"
concept: "Tree Care Robot"
description: "A low-speed autonomous service robot monitors tree and plant health across Roosevelt Island’s green spaces, helping maintenance teams detect stress, storm damage, and environmental risks before they become larger problems."
author: "Jaspreet Lal"
type: "service"
geojson: "boundary.geojson"
media:
  - file: "hero-image.jpg"
    caption: "Autonomous tree care robot scanning trees and planting beds along a Roosevelt Island green corridor."
    featured: true
  - file: "street-view.jpg"
    caption: "Street-level rendering of the robot operating at walking speed while yielding to pedestrians and park users."
  - file: "site-plan.jpg"
    caption: "Site plan showing a sample robot route, tree-monitoring zones, charging dock, pedestrian-priority areas, and maintenance access points in the Four Freedoms Park."
slug: "roosevelt-island-tree-care-robot"
---
...
- **Result:** Produced `hero-image.jpg`, which shows the robot’s purpose and relationship to green corridors on Roosevelt Island.
...
- **Result:** Produced `street-view.jpg`, showing the robot operating cautiously in a human-centered public-space environment.
...
- **Result:** Produced `site-plan.jpg`, a visual diagram clarifying the robot’s operating route, monitoring zones, charging location, and pedestrian-priority areas.
...
- **Result:** Created `boundary.geojson`, which maps the project area for the Robot Island case study.