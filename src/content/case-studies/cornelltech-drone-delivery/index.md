---
title: "Cornell Tech Drone Landing Port — LIC Food Delivery Corridor"
place: "Cornell Tech North Lawn"
concept: "East River Airlift"
description: "A supervised drone food-delivery corridor links LIC restaurants near the Pepsi-Cola Sign to a safe, public-facing landing and pickup port on the Cornell Tech campus."
author: "Wenxuan Yu"
type: "freight"
geojson: "boundary.geojson"
media:
  - file: "hero-image.jpg"
    caption: "Cornell Tech side drone station with captions"
    featured: true
  - file: "lic-side-image.png"
    caption: "Featured view of the LIC take-off station at Pepsi-Cola Sign Park, where DoorDash, Uber Eats, and HungryPanda couriers queue to load sealed food orders into a color-coded drone dispatch kiosk."
  - file: "cornell-side-image.png"
    caption: "Cornell Tech receiving station on the Roosevelt Island lawn, with a raised Cornell-red landing platform, pickup lockers, and an organized waiting area separated from the drone pad."
  - file: "corridor-animation.mp4"
    caption: "Short animation showing a courier loading food at LIC, the drone crossing the East River, and the order arriving at the Cornell Tech landing port."
slug: "cornelltech-drone-delivery"
---
