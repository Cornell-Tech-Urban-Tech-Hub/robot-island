---
title: "Roosevelt Access Loop — Elderly-First Autonomous Mobility Corridor"
place: "Main Street Corridor"
concept: "Elderly-First Mobility Corridor"
description: "A care-centered autonomous shuttle network reimagines the Main Street corridor between Tram Plaza and the Octagon as a low-speed, accessibility-first mobility corridor serving elderly and mobility-impaired residents along this central residential spine."
author: "Xavier Yin"
type: "passenger"
geojson: "boundary.geojson"
media:
  - file: "hero-image.jpg"
    caption: "Street-level view of the Main Street corridor showing an autonomous shuttle pod in mixed traffic, elderly and wheelchair users on the sidewalk, and a boarding node shelter ahead"
    featured: true
  - file: "boarding-node.jpg"
    caption: "Street-level view of an Access Loop boarding node at Rivercross: flush platform, weather shelter, and blue-tinted permeable pavement marking the loading zone"
  - file: "interior-view.jpg"
    caption: "Interior of an Access Loop pod showing low-floor wheelchair ramp, priority seating, and audio announcement display"
  - file: "corridor-plan.png"
    caption: "Cross-section diagram of Main Street at a boarding node, showing shared traffic lanes, raised speed table, blue-tinted boarding area, flush-level platform, and shelter — with zone widths labeled"
  - file: "access-loop-animation.mp4"
    caption: "Animation showing a pod arriving at the Westview boarding node, doors opening for a wheelchair user, and departing northbound along the redesigned corridor"
slug: "elderly-first-av-corridor"
---
