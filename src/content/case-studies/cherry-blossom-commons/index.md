---
title: "Cherry Blossom Commons — Seasonal Service Rovers for the Roosevelt Island Waterfront"
place: "Roosevelt Island Southern Waterfront"
concept: "Seasonal Park Attendants"
description: "A temporary fleet of low-speed autonomous service rovers and modular charging kiosks helps Roosevelt Island manage cherry blossom crowds along its southern waterfront paths."
author: "Nadiem Ahmed"
type: "service"
geojson: "boundary.geojson"
media:
  - file: "hero-image.jpg"
    caption: "Peak cherry blossom crowds along the Roosevelt Island waterfront, with low-speed service rovers operating at the edges of the pedestrian flow."
    featured: true
  - file: "night-charging.jpg"
    caption: "After-hours charging and storage kiosk with rovers docked, maintenance supplies stored, and the waterfront path kept clear."
  - file: "worker-accessibility.jpg"
    caption: "A single waterfront path where one rover supports park maintenance while another assists a family carrying picnic supplies."
  - file: "kiosk-rover-system-board.jpg"
    caption: "Design board combining the modular charging/storage kiosk with the matching service rover and cargo modules."
slug: "cherry-blossom-commons"
---
...
- **Result:** Created a `boundary.geojson` file that frames the proposal as a place-specific intervention rather than a generic AV service.
